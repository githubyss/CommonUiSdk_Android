...
import com.githubyss.common.kit.manager.audio_player.enumeration.AudioState
import com.githubyss.common.kit.manager.audio_player.enumeration.VoiceType
...
import com.githubyss.common.kit.manager.audio_player.player.AudioPlayListener
...
import com.githubyss.common.ui.databinding.ComuiFloatingAudioPlayerBinding
import com.githubyss.common.ui.floating_view.classical.feature.autoshorten.AutoShortenView
...
class AudioPlayerViewAutoShorten : AutoShortenView, AudioPlayerViewInterface {
    ...
    override fun play(audioList: List<AudioModel?>?) {
        ...
        if (designateView != null) {
            ...
            //     } else {
            //         ComkitINSTANCE.showToast(containerContext, getStringFromRes(containerContext, R.string.music_play_no_list), Toast.LENGTH_SHORT, false);
            //     }
            // } else {
