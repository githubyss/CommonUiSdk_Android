...
//  * @since : 2021/1/7
//  */
// class com.githubyss.common.ui.recycler_view.three_layer.old.HomeProductOutAdapter(val context: Context,
//                             val areaName: String?,
//                             val show180: Boolean,
//                             var mProductListItems: ArrayList<ArrayList<ProductItem>>?,
//                             var mProductItemHomeClickListener: HomeItemClickListener<ProductItem>)
//     : RecyclerView.Adapter<com.githubyss.common.ui.recycler_view.three_layer.old.HomeProductOutAdapter.ViewHolder>() {
...
//                     }
//                     val homeProductInAdapter = com.githubyss.common.ui.recycler_view.three_layer.old.HomeProductInAdapter(context, areaName, makeBg(position), show180,
...
//                     val homeProductInAdapter = com.githubyss.common.ui.recycler_view.three_layer.old.HomeProductInAdapter(context, areaName, makeBg(position), show180, mProductItems, mProductItemHomeClickListener)
//                     viewHolder.rvHomeOut.apply {
//                         layoutManager = object : LinearLayoutManager(context) {
//                             override fun canScrollVertically(): Boolean {
//                                 return false
