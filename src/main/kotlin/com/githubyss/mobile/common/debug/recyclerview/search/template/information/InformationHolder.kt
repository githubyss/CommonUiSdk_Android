...
class InformationHolder constructor(view: View) : RecyclerView.ViewHolder(view) {
    ...
    var tvTitle = view.findViewById(R.id.textView_recyclerInformationTitle) as TextView
    var tvContent = view.findViewById(R.id.textView_recyclerInformationContent) as TextView
