 ...
 */
class InsuranceProductAdapter constructor(private val dataList: List<BaseItemModel>, private val keyList: ArrayList<String>) : BaseItemAdapter(dataList) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, @ItemType viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ItemType.ITEM -> {
                InsuranceProductHolder(LayoutInflater.from(parent.context)
                    .inflate(R.layout.comui_list_item_insurance_product, parent, false))
            }
            else -> {
