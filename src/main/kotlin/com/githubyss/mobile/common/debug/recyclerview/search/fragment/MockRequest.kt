...
object MockRequest {
    ...
    fun requestFundProduct(context: Context, hasHeader: Boolean = false, onItemClickListener: BaseItemAdapter.OnItemClickListener? = null): ArrayList<BaseItemModel> {
        ...
        fundProductItemList.add(FundProductModel("易方达消费行业基金", "+15.79%", "112041", "高风险", "混合型", "最近一年增长率", "超过800万关注", false, "https://FundProduct1", ItemType.ITEM))
        fundProductItemList.add(FundProductModel("易方达地产行业基金", "+12.88%", "112042", "中高风险", "混合型", "最近一年增长率", "超过800万关注", true, "https://FundProduct2", ItemType.ITEM))
        fundProductItemList.add(FundProductModel("博时家电行业基金", "+10.65%", "112043", "中低风险", "混合型", "最近一年增长率", "超过100万关注", true, "https://FundProduct3", ItemType.ITEM))
        
        val fundProductList = ArrayList<BaseItemModel>()
        if (hasHeader) fundProductList.add(HeaderSeeMoreModel(SectionId.FUND_PRODUCT, "基金产品", true, ItemType.HEADER))
        fundProductList.add(ListModel(FundProductAdapter(fundProductItemList), RecyclerView.VERTICAL, context, onItemClickListener, ItemType.ITEM))
    ...
    fun requestFundTopic(context: Context, hasHeader: Boolean = false, onItemClickListener: BaseItemAdapter.OnItemClickListener? = null): ArrayList<BaseItemModel> {
        ...
        if (hasHeader) fundTopicList.add(HeaderSeeMoreModel(SectionId.FUND_TOPIC, "热门基金主题", true, ItemType.HEADER))
        fundTopicList.add(ListModel(FundTopicAdapter(fundTopicItemList), RecyclerView.VERTICAL, context, onItemClickListener, ItemType.ITEM))
    ...
    fun requestFundManager(context: Context, hasHeader: Boolean = false, onItemClickListener: BaseItemAdapter.OnItemClickListener? = null): ArrayList<BaseItemModel> {
        ...
        fundManagerItemList.add(FundManagerModel("", "张坤", "任期最佳回报", "+15.26%", "基金经理简介基金经理简介基金经理简介基金经理简介基金经理简介基金经理基金经理简介基金经理简…", "https://FundManager2", ItemType.ITEM))
        fundManagerItemList.add(FundManagerModel("", "王远", "任期最佳回报", "+15.26%", "基金经理简介基金经理简介基金经理简介基金经理简介基金经理简介基金经理基金经理简介基金经理简…", "https://FundManager3", ItemType.ITEM))
    ...
    fun requestGoldProduct(context: Context, hasHeader: Boolean = false, onItemClickListener: BaseItemAdapter.OnItemClickListener? = null): ArrayList<BaseItemModel> {
        ...
        goldProductList.add(ListModel(GoldProductAdapter(goldProductItemList), RecyclerView.VERTICAL, context, onItemClickListener, ItemType.ITEM))
    ...
    fun requestInsuranceProduct(context: Context, hasHeader: Boolean = false, onItemClickListener: BaseItemAdapter.OnItemClickListener? = null): ArrayList<BaseItemModel> {
        ...
        insuranceProductList.add(ListModel(InsuranceProductAdapter(insuranceProductItemList), RecyclerView.VERTICAL, context, onItemClickListener, ItemType.ITEM))
    ...
    fun requestFinanceAq(context: Context, hasHeader: Boolean = false, onItemClickListener: BaseItemAdapter.OnItemClickListener? = null): ArrayList<BaseItemModel> {
        ...
        financeAqList.add(ListModel(FinanceAqAdapter(financeAqItemList), RecyclerView.VERTICAL, context, onItemClickListener, ItemType.ITEM))
    ...
    fun requestFaq(context: Context, hasHeader: Boolean = false, onItemClickListener: BaseItemAdapter.OnItemClickListener? = null): ArrayList<BaseItemModel> {
        ...
        faqList.add(ListModel(FaqAdapter(faqItemList), RecyclerView.VERTICAL, context, onItemClickListener, ItemType.ITEM))
    ...
    fun requestInformation(context: Context, hasHeader: Boolean = false, onItemClickListener: BaseItemAdapter.OnItemClickListener? = null): ArrayList<BaseItemModel> {
        ...
        informationList.add(ListModel(InformationAdapter(informationItemList), RecyclerView.VERTICAL, context, onItemClickListener, ItemType.ITEM))
    ...
    fun requestWealthAccount(context: Context, hasHeader: Boolean = false, onItemClickListener: BaseItemAdapter.OnItemClickListener? = null): ArrayList<BaseItemModel> {
        ...
        wealthAccountItemList.add(WealthAccountModel("", "广发基金", "说明文案说明文案说明文案说明…", false, "https://WealthAccount1", ItemType.ITEM))
        wealthAccountItemList.add(WealthAccountModel("", "苏宁银行金融市场", "说明文案说明文案说明文案说明…", true, "https://WealthAccount2", ItemType.ITEM))
        wealthAccountItemList.add(WealthAccountModel("", "投资策略研究中心", "说明文案说明文案说明文案说明…", true, "https://WealthAccount3", ItemType.ITEM))
        ...
        wealthAccountList.add(ListModel(WealthAccountAdapter(wealthAccountItemList), RecyclerView.VERTICAL, context, onItemClickListener, ItemType.ITEM))
