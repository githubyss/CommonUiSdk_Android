...
class FundProductHolder constructor(view: View) : RecyclerView.ViewHolder(view) {
    ...
    var tvTitle = view.findViewById(R.id.textView_recyclerFundProductTitle) as KeyWordHighlightTextView
    ...
    var tglBtnIsFollowed = view.findViewById(R.id.button_recyclerFundProductIsFollowed) as Button
}
