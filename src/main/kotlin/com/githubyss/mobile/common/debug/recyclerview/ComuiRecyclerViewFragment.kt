...
import com.githubyss.mobile.common.ui.recyclerview.multitype.MultiTextViewHolder
...
import kotlinx.android.synthetic.main.comui_item_multi_text.view.*
        ...
        override fun onItemClick(holder: RecyclerView.ViewHolder, position: Int) {
            when (holder) {
                is MultiTextViewHolder -> {
                    ToastUtils.showMessage(msgStr = "${holder.tvTitle.text} was selected")
                }
            }
        }
    }
