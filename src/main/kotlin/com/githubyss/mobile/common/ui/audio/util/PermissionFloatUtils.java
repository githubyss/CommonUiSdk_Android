...
//
// import com.suning.mobile.epa.model.moreinfo.NewSwitchBean;
//
...
//             return true;
//         }
//         NewSwitchBean.SwitchInfo info = NewSwitchBean.getInstance().getSwitchInfo(NewSwitchBean.AUDIO_FLOAT);
//         if (info == null || TextUtils.isEmpty(info.moduleDesc)) {
//             return false;
//         }
//         try {
//             JSONObject desc = new JSONObject(info.moduleDesc);
//             if (isExistence(desc.getJSONArray(WHITE))) {
//                 //若是存在白名单则放行。
//                 return false;
//             } else if (isExistence(desc.getJSONArray(BLACK))) {
//                 //若是存在黑名单则要权限。
//                 return true;
//             }
