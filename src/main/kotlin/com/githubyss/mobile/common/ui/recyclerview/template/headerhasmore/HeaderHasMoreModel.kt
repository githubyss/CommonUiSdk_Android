...
data class HeaderHasMoreModel constructor(@ItemType override var type: Int) : BaseItemModel(type) {
    ...
    constructor(moduleKey: String, title: String, @HasMore hasMore: String, itemList: ArrayList<BaseItemModel>, keyList: ArrayList<String>, @ItemType type: Int) : this(type) {
