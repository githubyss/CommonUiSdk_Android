...
//
// class SlideToRefreshScrollView {
//
//     /**
//      * 添加下拉刷新开关,下拉不监听了
//      * 滑动结束时scrollY在0到100范围内时，强制要求滑到0或100
//      */
//     class PullToRefreshScrollView2 : NestedScrollView {
//         companion object {
//             val TAG = SlideToRefreshScrollView::class.java.simpleName
//             private const val TAG = "PullToRefreshScrollView2"
...
//         private var tvForCamera: TextView? = null
...
//         //     initHeadPadding()
//         //     headView = inflater.inflate(R.layout.layout_refresh_scroll_default_head2, null) as LinearLayout
//         //     ivPullLoading = headView!!.findViewById(R.id.iv_pull_loading)
//         //     //帧动画
//         //     ivPullLoading!!.setBackgroundResource(R.drawable.pull_to_refresh_frame_anim)
//         //     animationDrawable = ivPullLoading!!.background as AnimationDrawable
//         //     animationDrawable!!.start()
//         //     tvPullLoading = headView!!.findViewById(R.id.tv_pull_loading)
//         //     tvForCamera = headView!!.findViewById(R.id.tv_for_camera)
//         //     tvForCamera!!.visibility = View.VISIBLE
//         //     measureView(headView)
//         //     headContentHeight = headView!!.measuredHeight
//         //     headView!!.setPadding(0, -headContentHeight, 0, 0)
//         //     headView!!.invalidate()
//         //     parent.addView(headView, 0)
//         //     state = DONE
//         //     isRefreshable = false
//         //     canReturn = false
//         // }
...
//             mHeadPadding = (HEAD_PADDING * scale + 0.5f).toInt()
//         }
//
...
//         }
//
//         private fun measureView(child: LinearLayout?) {
...
//             when (state) {
//                 DONE -> {
//                     val currentTop = headView!!.paddingTop.toFloat()
...
//                         headView!!.setPadding(0, value.toInt(), 0, 0)
//                     }
...
//                     headView!!.setPadding(0, mHeadPadding, 0, mHeadPadding)
//                 }
//                 else -> {
//                 }
//             }
...
//             return if (headView!!.height > Nums.FIVE) {
//                 true
//             } else try {
