...
//                            var mProductItemHomeClickListener: ItemClickListener<ProductItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder?>() {
...
//             // 180-借钱头部(独立一个)
//             "011" -> type = 11
//             "021" -> type = if (mProductItems!!.size == 1) 9921 else if (mProductItems!!.size == 2) 99921 else 21
//             "030" -> type = 30
//             "040" -> type = 40
//             "051" -> type = 51
//             "061" -> type = 61
//             "071" -> type = if (mProductItems!!.size == 1) 9971 else 71
//             "080" -> type = 80
//             "090" -> type = 90
//             "100" -> type = 100
//             "111" -> type = 111//该模版不要了
...
//             "130" -> type = 130
//             "140" -> type = 140
//             "151" -> type = if (mProductItems!!.size == 1) 99151 else if (mProductItems!!.size == 2) 999151 else 151
//             "170" -> type = 170 //160是财顾，不在这里渲染
//             "180" -> type = 180
//             "191" -> type = if (mProductItems!!.size == 1) 99191 else 191
//             "200" -> type = 200
//             "210" -> type = 210
//             "220" -> type = 220
//             "230" -> type = 230
...
//     }
//
//     inner class WealthViewHolderSingle(itemView: View) : TypeAbstartViewHolder(itemView) {
...
//     }
//
//     inner class WealthViewHolderDouble(itemView: View) : TypeAbstartViewHolder(itemView) {
...
//     }
//
//     inner class BetterViewHolderSingle(itemView: View) : TypeAbstartViewHolder(itemView) {
...
//     }
//
//     inner class WealthViewHolder2Single(itemView: View) : TypeAbstartViewHolder(itemView) {
...
//     }
//
//     inner class WealthViewHolder2Double(itemView: View) : TypeAbstartViewHolder(itemView) {
...
//     }
//
//     inner class Better191ViewHolderSingle(itemView: View) : TypeAbstartViewHolder(itemView) {
...
//      * 260，理财子
//      */
//     inner class Licai260ViewHolder(itemView: View) : TypeAbstartViewHolder(itemView) {
...
//      * 270，简易版首页产品
//      */
//     inner class HomeSimpleProduct270ViewHolder(itemView: View) : TypeAbstartViewHolder(itemView) {
...
//                 override fun onGapClick(v: View?) {
//                     if (productItem != null) {
//                         if (productItem.joinType == Strs.ONE || productItem.joinType == Strs.ZERO || productItem.joinType == Strs.FOUR || !productItem.joinTip.isNullOrBlank()) {
//                             mProductItemHomeClickListener.onItemClick(productItem)
//                         }
//                     }
//                 }
...
//      * 300，理财子普通
//      */
//     inner class Licai300ViewHolder(itemView: View) : TypeAbstartViewHolder(itemView) {
//         private var llFinance: LinearLayout = itemView.findViewById(R.id.ll_finance) as LinearLayout
...
//      * 310，理财子爆款
//      */
//     inner class Licai310ViewHolder(itemView: View) : TypeAbstartViewHolder(itemView) {
//         private var llFinance: LinearLayout = itemView.findViewById(R.id.ll_finance) as LinearLayout
//         private var tvLicaiTitle: TextView = itemView.findViewById<View>(R.id.tv_licai_title) as TextView
//         private var ivLicaiDiv: ImageView = itemView.findViewById<View>(R.id.iv_licai_div) as ImageView
//         private var tvLicaiSubtitle: TextView = itemView.findViewById<View>(R.id.tv_licai_subtitle) as TextView
