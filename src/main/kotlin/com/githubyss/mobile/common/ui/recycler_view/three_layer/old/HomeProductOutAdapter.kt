...
//                             var mProductItemHomeClickListener: ItemClickListener<ProductItem>)
...
//                     })
//                 }
//                 "080", "090", "100", "120", "130", "170", "220", "210", "240", "230", "200", "140", "250", "260", "270", "300", "310" -> {
...
//                 }
//                 "111" -> {//接下来网格布局
//                     // 这里的layoutManager会有变化  021是财富产品配置样式，151是保险产品配置样式，111是老的基金貌似不要了
//                     val newProduct = ArrayList<ProductItem>()
...
//                 }
//                 "021", "151" -> {//接下来网格布局
//                     // 这里的layoutManager会有变化  021是财富产品配置样式，151是保险产品配置样式
//                     val newProduct = ArrayList<ProductItem>()
//                     if (mProductItems.size > 3) {
//                         for (i in 0..2) {
//                             newProduct.add(mProductItems[i])
...
//                             if (mProductItems.size > 3) newProduct else mProductItems, mProductItemHomeClickListener)
//                     viewHolder.rvHomeOut.apply {
//                         layoutManager = when (mProductItems.size) {
//                             2 -> object : GridLayoutManager(context, 2) {
//                                 override fun canScrollVertically(): Boolean {
//                                     return false
//                                 }
//                             }
//                             1 -> object : LinearLayoutManager(context) {
//                                 override fun canScrollVertically(): Boolean {
//                                     return false
//                                 }
//                             }
...
//                     }
//                 }
//                 "071", "191" -> {//接下来网格布局 这里的layoutManager会有变化，71和191基本是一样的，都动了吧，是UI中的贷款产品配置样式
//                     val newProduct = ArrayList<ProductItem>()
...
//         val rvHomeOut: RecyclerView = itemView.findViewById(R.id.rv_with_layout_manager)
//     }
// }