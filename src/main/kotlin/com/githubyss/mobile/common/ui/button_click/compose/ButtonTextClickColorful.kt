...
fun ButtonTextClickBlue(
    ...
    text: String,
    fontSize: TextUnit = ButtonDefaults.buttonClickBlueFontSize,
    ...
    ButtonTextClickCommon(
        ...
        ButtonDefaults.buttonClickBlueShape,
...
fun ButtonTextClickWhite(
    modifier: Modifier = Modifier,
    text: String,
    fontSize: TextUnit = ButtonDefaults.buttonClickWhiteFontSize,
    marginHorizontal: Dp = Dp.SideNone,
    marginVertical: Dp = Dp.SideNone,
    paddingHorizontal: Dp = Dp.SideNone,
    paddingVertical: Dp = Dp.SideNone,
    ...
    ButtonTextClickCommon(
        ...
        ButtonDefaults.buttonClickWhiteShape,
...
fun ButtonTextClickTransparent(
    modifier: Modifier = Modifier,
    text: String,
    fontSize: TextUnit = ButtonDefaults.buttonClickTransparentFontSize,
    marginHorizontal: Dp = Dp.SideNone,
    marginVertical: Dp = Dp.SideNone,
    paddingHorizontal: Dp = Dp.SideNone,
    paddingVertical: Dp = Dp.SideNone,
    ...
    ButtonTextClickCommon(
        ...
        ButtonDefaults.buttonClickTransparentShape,
