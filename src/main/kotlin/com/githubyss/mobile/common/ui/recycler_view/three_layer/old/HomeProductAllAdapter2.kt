package com.githubyss.mobile.common.ui.recycler_view.three_layer.old // package com.suning.mobile.snbank.homek.adapter
//
...
// import com.githubyss.mobile.common.ui.recycler_view.three_layer.old.HomeProductOutAdapter
...
//         val homeProductOutAdapter = HomeProductOutAdapter(context, mProductInfos.productName, show180, mProductInfos.prodRowModels, mProductItemHomeClickListener)
...
//         })
//         //TODO 逻辑重复了，应该只保留一个
//         viewHolder.llTitleArea.visibility = View.GONE
