package com.githubyss.mobile.common.ui.app.page.recycler_view.multi.page
 ...
 */
class MultiTypeRecyclerViewFragment : BaseInlineBindingToolbarFragment(R.layout.comui_fragment_multi_type_recycler_view) {

    /** ****************************** Properties ****************************** */

    companion object {
        val TAG: String = MultiTypeRecyclerViewFragment::class.java.simpleName
    }

    private val binding by bindView<ComuiFragmentMultiTypeRecyclerViewBinding>()
